...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-cnenp!%l&3^afk8u46k38wxvssj7ec+#^rjs6pwj*t34v)(+5m')
...
# For production, comment the above and use SMTP:
